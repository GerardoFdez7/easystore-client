...
export type CreateAddressMutation = { __typename?: 'Mutation', createAddress: { __typename?: 'AddressType', addressLine1: string, addressLine2: string, addressType: AddressTypeEnum, city: string, countryId: string, deliveryNum: string, name: string, postalCode: string } };
...
export type UpdateAddressMutation = { __typename?: 'Mutation', updateAddress: { __typename?: 'AddressType', addressLine1: string, addressLine2: string, addressType: AddressTypeEnum, city: string, countryId: string, deliveryNum: string, name: string, postalCode: string } };
...
export type DeleteAddressMutation = { __typename?: 'Mutation', deleteAddress: { __typename?: 'AddressType', addressLine1: string, addressLine2: string, addressType: AddressTypeEnum, city: string, countryId: string, deliveryNum: string, name: string, postalCode: string } };
...
export type FindAddressByIdQuery = { __typename?: 'Query', getAddressById: { __typename?: 'AddressType', addressLine1: string, addressLine2: string, addressType: AddressTypeEnum, city: string, countryId: string, deliveryNum: string, name: string, postalCode: string } };
...
export type FindAllAddressesQuery = { __typename?: 'Query', getAllAddresses: { __typename?: 'AddressesType', addresses: Array<{ __typename?: 'AddressType', addressLine1: string, addressLine2: string, addressType: AddressTypeEnum, city: string, countryId: string, deliveryNum: string, name: string, postalCode: string }> } };
...
export type AddStockToWarehouseMutation = { __typename?: 'Mutation', addStockToWarehouse: { __typename?: 'Warehouse', id: string, name: string, addressId: string, createdAt: any, updatedAt: any, stockPerWarehouses: Array<{ __typename?: 'StockPerWarehouse', id: string, warehouseId: string, qtyAvailable: number, qtyReserved: number, lotNumber?: string | null, serialNumbers?: Array<string> | null, productLocation?: string | null, estimatedReplenishmentDate?: any | null }> } };
...
export type CreateWarehouseMutation = { __typename?: 'Mutation', createWarehouse: { __typename?: 'Warehouse', id: string, name: string, addressId: string, createdAt: any, updatedAt: any, stockPerWarehouses: Array<{ __typename?: 'StockPerWarehouse', id: string, warehouseId: string, qtyAvailable: number, qtyReserved: number, lotNumber?: string | null, serialNumbers?: Array<string> | null, productLocation?: string | null, estimatedReplenishmentDate?: any | null }> } };
...
export type UpdateWarehouseMutation = { __typename?: 'Mutation', updateWarehouse: { __typename?: 'Warehouse', id: string, name: string, addressId: string, createdAt: any, updatedAt: any, stockPerWarehouses: Array<{ __typename?: 'StockPerWarehouse', id: string, warehouseId: string, qtyAvailable: number, qtyReserved: number, lotNumber?: string | null, serialNumbers?: Array<string> | null, productLocation?: string | null, estimatedReplenishmentDate?: any | null }> } };
...
export type DeleteWarehouseMutation = { __typename?: 'Mutation', deleteWarehouse: { __typename?: 'Warehouse', id: string, name: string, addressId: string, createdAt: any, updatedAt: any, stockPerWarehouses: Array<{ __typename?: 'StockPerWarehouse', id: string, warehouseId: string, qtyAvailable: number, qtyReserved: number, lotNumber?: string | null, serialNumbers?: Array<string> | null, productLocation?: string | null, estimatedReplenishmentDate?: any | null }> } };
...
export type FindWarehouseByIdQuery = { __typename?: 'Query', getWarehouseById: { __typename?: 'Warehouse', id: string, name: string, addressId: string, createdAt: any, updatedAt: any, stockPerWarehouses: Array<{ __typename?: 'StockPerWarehouse', id: string, warehouseId: string, qtyAvailable: number, qtyReserved: number, lotNumber?: string | null, serialNumbers?: Array<string> | null, productLocation?: string | null, estimatedReplenishmentDate?: any | null }> } };
...
export type FindAllWarehousesQuery = { __typename?: 'Query', getAllWarehouses: { __typename?: 'PaginatedWarehousesType', total: number, hasMore: boolean, warehouses: Array<{ __typename?: 'Warehouse', id: string, name: string, addressId: string, createdAt: any, updatedAt: any, stockPerWarehouses: Array<{ __typename?: 'StockPerWarehouse', id: string, warehouseId: string, qtyAvailable: number, qtyReserved: number, lotNumber?: string | null, serialNumbers?: Array<string> | null, productLocation?: string | null, estimatedReplenishmentDate?: any | null }> }> } };
...
export type FindAllProductsQueryVariables = Exact<{
  page?: InputMaybe<Scalars['Float']['input']>;
  limit?: InputMaybe<Scalars['Float']['input']>;
  categoriesIds?: InputMaybe<Array<Scalars['Int']['input']> | Scalars['Int']['input']>;
  type?: InputMaybe<TypeEnum>;
  sortBy?: InputMaybe<SortBy>;
  sortOrder?: InputMaybe<SortOrder>;
  includeSoftDeleted?: InputMaybe<Scalars['Boolean']['input']>;
 ...
 * });
 */
export function useFindAddressByIdQuery(baseOptions: Apollo.QueryHookOptions<FindAddressByIdQuery, FindAddressByIdQueryVariables> & ({ variables: FindAddressByIdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<FindAddressByIdQuery, FindAddressByIdQueryVariables>(FindAddressByIdDocument, options);
      }
export function useFindAddressByIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<FindAddressByIdQuery, FindAddressByIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<FindAddressByIdQuery, FindAddressByIdQueryVariables>(FindAddressByIdDocument, options);
        }
export function useFindAddressByIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<FindAddressByIdQuery, FindAddressByIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<FindAddressByIdQuery, FindAddressByIdQueryVariables>(FindAddressByIdDocument, options);
        }
export type FindAddressByIdQueryHookResult = ReturnType<typeof useFindAddressByIdQuery>;
export type FindAddressByIdLazyQueryHookResult = ReturnType<typeof useFindAddressByIdLazyQuery>;
export type FindAddressByIdSuspenseQueryHookResult = ReturnType<typeof useFindAddressByIdSuspenseQuery>;
export type FindAddressByIdQueryResult = Apollo.QueryResult<FindAddressByIdQuery, FindAddressByIdQueryVariables>;
 ...
 * });
 */
export function useFindAllAddressesQuery(baseOptions?: Apollo.QueryHookOptions<FindAllAddressesQuery, FindAllAddressesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<FindAllAddressesQuery, FindAllAddressesQueryVariables>(FindAllAddressesDocument, options);
      }
export function useFindAllAddressesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<FindAllAddressesQuery, FindAllAddressesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<FindAllAddressesQuery, FindAllAddressesQueryVariables>(FindAllAddressesDocument, options);
        }
export function useFindAllAddressesSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<FindAllAddressesQuery, FindAllAddressesQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<FindAllAddressesQuery, FindAllAddressesQueryVariables>(FindAllAddressesDocument, options);
        }
export type FindAllAddressesQueryHookResult = ReturnType<typeof useFindAllAddressesQuery>;
export type FindAllAddressesLazyQueryHookResult = ReturnType<typeof useFindAllAddressesLazyQuery>;
export type FindAllAddressesSuspenseQueryHookResult = ReturnType<typeof useFindAllAddressesSuspenseQuery>;
export type FindAllAddressesQueryResult = Apollo.QueryResult<FindAllAddressesQuery, FindAllAddressesQueryVariables>;
export const RegisterDocument = gql`
    mutation register($email: String!, $password: String!, $accountType: AccountTypeEnum!) {
  register(input: {email: $email, password: $password, accountType: $accountType}) {
    email
    accountType
  }
}
...
export const LoginDocument = gql`
    mutation login($email: String!, $password: String!, $accountType: AccountTypeEnum!) {
  login(input: {email: $email, password: $password, accountType: $accountType}) {
    success
    message
  }
}
...
export const GetInTouchDocument = gql`
    mutation getInTouch($fullName: String!, $businessEmail: String!, $businessPhone: String!, $company: String!, $websiteUrl: String!, $country: String!, $annualRevenue: String!, $isAgency: String!) {
  getInTouch(
    input: {fullName: $fullName, businessEmail: $businessEmail, businessPhone: $businessPhone, company: $company, websiteUrl: $websiteUrl, country: $country, annualRevenue: $annualRevenue, isAgency: $isAgency}
  ) {
    success
    message
  }
...
export function useGetInTouchMutation(baseOptions?: Apollo.MutationHookOptions<GetInTouchMutation, GetInTouchMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<GetInTouchMutation, GetInTouchMutationVariables>(GetInTouchDocument, options);
      }
...
export function useFindCategoryByIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<FindCategoryByIdQuery, FindCategoryByIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
...
export const FindAllCategoriesDocument = gql`
    query findAllCategories($page: Int = 1, $limit: Int = 25, $name: String = "", $parentId: ID = "", $sortBy: SortBy = CREATED_AT, $sortOrder: SortOrder = DESC) {
  getAllCategories(
    page: $page
    limit: $limit
    name: $name
...
export const FindAllMovementsDocument = gql`
    query findAllMovements($warehouseId: ID!, $page: Int = 1, $limit: Int = 10, $variantId: ID, $createdById: ID, $dateFrom: DateTime, $dateTo: DateTime, $includeDeleted: Boolean = false, $sortBy: SortBy, $sortOrder: SortOrder) {
 ...
 * });
 */
export function useFindAllMovementsQuery(baseOptions: Apollo.QueryHookOptions<FindAllMovementsQuery, FindAllMovementsQueryVariables> & ({ variables: FindAllMovementsQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<FindAllMovementsQuery, FindAllMovementsQueryVariables>(FindAllMovementsDocument, options);
      }
export function useFindAllMovementsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<FindAllMovementsQuery, FindAllMovementsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<FindAllMovementsQuery, FindAllMovementsQueryVariables>(FindAllMovementsDocument, options);
        }
export function useFindAllMovementsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<FindAllMovementsQuery, FindAllMovementsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<FindAllMovementsQuery, FindAllMovementsQueryVariables>(FindAllMovementsDocument, options);
        }
export type FindAllMovementsQueryHookResult = ReturnType<typeof useFindAllMovementsQuery>;
export type FindAllMovementsLazyQueryHookResult = ReturnType<typeof useFindAllMovementsLazyQuery>;
export type FindAllMovementsSuspenseQueryHookResult = ReturnType<typeof useFindAllMovementsSuspenseQuery>;
export type FindAllMovementsQueryResult = Apollo.QueryResult<FindAllMovementsQuery, FindAllMovementsQueryVariables>;
export const AddStockToWarehouseDocument = gql`
    mutation addStockToWarehouse($warehouseId: ID!, $variantId: ID!, $input: AddStockToWarehouseInput!, $reason: String) {
  addStockToWarehouse(
    warehouseId: $warehouseId
    variantId: $variantId
    input: $input
    ...
    `;
export type AddStockToWarehouseMutationFn = Apollo.MutationFunction<AddStockToWarehouseMutation, AddStockToWarehouseMutationVariables>;
 ...
 * });
 */
export function useAddStockToWarehouseMutation(baseOptions?: Apollo.MutationHookOptions<AddStockToWarehouseMutation, AddStockToWarehouseMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<AddStockToWarehouseMutation, AddStockToWarehouseMutationVariables>(AddStockToWarehouseDocument, options);
      }
export type AddStockToWarehouseMutationHookResult = ReturnType<typeof useAddStockToWarehouseMutation>;
export type AddStockToWarehouseMutationResult = Apollo.MutationResult<AddStockToWarehouseMutation>;
export type AddStockToWarehouseMutationOptions = Apollo.BaseMutationOptions<AddStockToWarehouseMutation, AddStockToWarehouseMutationVariables>;
export const UpdateStockInWarehouseDocument = gql`
    mutation updateStockInWarehouse($warehouseId: ID!, $stockId: ID!, $input: UpdateStockInWarehouseInput!, $reason: String) {
  updateStockInWarehouse(
    ...
    `;
export type UpdateStockInWarehouseMutationFn = Apollo.MutationFunction<UpdateStockInWarehouseMutation, UpdateStockInWarehouseMutationVariables>;
 ...
 * });
 */
export function useUpdateStockInWarehouseMutation(baseOptions?: Apollo.MutationHookOptions<UpdateStockInWarehouseMutation, UpdateStockInWarehouseMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateStockInWarehouseMutation, UpdateStockInWarehouseMutationVariables>(UpdateStockInWarehouseDocument, options);
      }
export type UpdateStockInWarehouseMutationHookResult = ReturnType<typeof useUpdateStockInWarehouseMutation>;
export type UpdateStockInWarehouseMutationResult = Apollo.MutationResult<UpdateStockInWarehouseMutation>;
export type UpdateStockInWarehouseMutationOptions = Apollo.BaseMutationOptions<UpdateStockInWarehouseMutation, UpdateStockInWarehouseMutationVariables>;
export const RemoveStockFromWarehouseDocument = gql`
    mutation removeStockFromWarehouse($warehouseId: ID!, $stockId: ID!, $reason: String) {
  removeStockFromWarehouse(
    ...
    `;
export type RemoveStockFromWarehouseMutationFn = Apollo.MutationFunction<RemoveStockFromWarehouseMutation, RemoveStockFromWarehouseMutationVariables>;
 ...
 * });
 */
export function useRemoveStockFromWarehouseMutation(baseOptions?: Apollo.MutationHookOptions<RemoveStockFromWarehouseMutation, RemoveStockFromWarehouseMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<RemoveStockFromWarehouseMutation, RemoveStockFromWarehouseMutationVariables>(RemoveStockFromWarehouseDocument, options);
      }
export type RemoveStockFromWarehouseMutationHookResult = ReturnType<typeof useRemoveStockFromWarehouseMutation>;
export type RemoveStockFromWarehouseMutationResult = Apollo.MutationResult<RemoveStockFromWarehouseMutation>;
export type RemoveStockFromWarehouseMutationOptions = Apollo.BaseMutationOptions<RemoveStockFromWarehouseMutation, RemoveStockFromWarehouseMutationVariables>;
 ...
 * });
 */
export function useFindWarehouseByIdQuery(baseOptions: Apollo.QueryHookOptions<FindWarehouseByIdQuery, FindWarehouseByIdQueryVariables> & ({ variables: FindWarehouseByIdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<FindWarehouseByIdQuery, FindWarehouseByIdQueryVariables>(FindWarehouseByIdDocument, options);
      }
export function useFindWarehouseByIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<FindWarehouseByIdQuery, FindWarehouseByIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<FindWarehouseByIdQuery, FindWarehouseByIdQueryVariables>(FindWarehouseByIdDocument, options);
        }
export function useFindWarehouseByIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<FindWarehouseByIdQuery, FindWarehouseByIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<FindWarehouseByIdQuery, FindWarehouseByIdQueryVariables>(FindWarehouseByIdDocument, options);
        }
export type FindWarehouseByIdQueryHookResult = ReturnType<typeof useFindWarehouseByIdQuery>;
export type FindWarehouseByIdLazyQueryHookResult = ReturnType<typeof useFindWarehouseByIdLazyQuery>;
export type FindWarehouseByIdSuspenseQueryHookResult = ReturnType<typeof useFindWarehouseByIdSuspenseQuery>;
export type FindWarehouseByIdQueryResult = Apollo.QueryResult<FindWarehouseByIdQuery, FindWarehouseByIdQueryVariables>;
export const FindAllWarehousesDocument = gql`
    query findAllWarehouses($page: Int = 1, $limit: Int = 10, $name: String, $addressId: ID, $variantId: ID, $lowStockThreshold: Int, $sortBy: SortBy, $sortOrder: SortOrder) {
  getAllWarehouses(
    page: $page
    limit: $limit
    name: $name
 ...
 * });
 */
export function useFindAllWarehousesQuery(baseOptions?: Apollo.QueryHookOptions<FindAllWarehousesQuery, FindAllWarehousesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<FindAllWarehousesQuery, FindAllWarehousesQueryVariables>(FindAllWarehousesDocument, options);
      }
export function useFindAllWarehousesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<FindAllWarehousesQuery, FindAllWarehousesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<FindAllWarehousesQuery, FindAllWarehousesQueryVariables>(FindAllWarehousesDocument, options);
        }
export function useFindAllWarehousesSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<FindAllWarehousesQuery, FindAllWarehousesQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<FindAllWarehousesQuery, FindAllWarehousesQueryVariables>(FindAllWarehousesDocument, options);
        }
export type FindAllWarehousesQueryHookResult = ReturnType<typeof useFindAllWarehousesQuery>;
export type FindAllWarehousesLazyQueryHookResult = ReturnType<typeof useFindAllWarehousesLazyQuery>;
export type FindAllWarehousesSuspenseQueryHookResult = ReturnType<typeof useFindAllWarehousesSuspenseQuery>;
export type FindAllWarehousesQueryResult = Apollo.QueryResult<FindAllWarehousesQuery, FindAllWarehousesQueryVariables>;
...
export const SoftDeleteDocument = gql`
  ...
  softDeleteProduct(id: $id) {
    ...
    `;
export type SoftDeleteMutationFn = Apollo.MutationFunction<SoftDeleteMutation, SoftDeleteMutationVariables>;
 ...
 * });
 */
export function useSoftDeleteMutation(baseOptions?: Apollo.MutationHookOptions<SoftDeleteMutation, SoftDeleteMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<SoftDeleteMutation, SoftDeleteMutationVariables>(SoftDeleteDocument, options);
      }
export type SoftDeleteMutationHookResult = ReturnType<typeof useSoftDeleteMutation>;
export type SoftDeleteMutationResult = Apollo.MutationResult<SoftDeleteMutation>;
export type SoftDeleteMutationOptions = Apollo.BaseMutationOptions<SoftDeleteMutation, SoftDeleteMutationVariables>;
...
export const HardDeleteDocument = gql`
  ...
  hardDeleteProduct(id: $id) {
    ...
    `;
export type HardDeleteMutationFn = Apollo.MutationFunction<HardDeleteMutation, HardDeleteMutationVariables>;
 ...
 * });
 */
export function useHardDeleteMutation(baseOptions?: Apollo.MutationHookOptions<HardDeleteMutation, HardDeleteMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<HardDeleteMutation, HardDeleteMutationVariables>(HardDeleteDocument, options);
      }
export type HardDeleteMutationHookResult = ReturnType<typeof useHardDeleteMutation>;
export type HardDeleteMutationResult = Apollo.MutationResult<HardDeleteMutation>;
export type HardDeleteMutationOptions = Apollo.BaseMutationOptions<HardDeleteMutation, HardDeleteMutationVariables>;
 ...
 * });
 */
export function useFindProductByIdQuery(baseOptions: Apollo.QueryHookOptions<FindProductByIdQuery, FindProductByIdQueryVariables> & ({ variables: FindProductByIdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
...
export function useFindProductByIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<FindProductByIdQuery, FindProductByIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<FindProductByIdQuery, FindProductByIdQueryVariables>(FindProductByIdDocument, options);
        }
...
export const FindAllProductsDocument = gql`
    query findAllProducts($page: Float = 1, $limit: Float = 10, $categoriesIds: [Int!] = [], $type: TypeEnum = PHYSICAL, $sortBy: SortBy = NAME, $sortOrder: SortOrder = ASC, $includeSoftDeleted: Boolean = false, $name: String = "") {
  getAllProducts(
    page: $page
    limit: $limit
...
export const AddVariantToProductDocument = gql`
  ...
  addVariant(input: $input) {
    ...
    `;
export type AddVariantToProductMutationFn = Apollo.MutationFunction<AddVariantToProductMutation, AddVariantToProductMutationVariables>;
 ...
 * });
 */
export function useAddVariantToProductMutation(baseOptions?: Apollo.MutationHookOptions<AddVariantToProductMutation, AddVariantToProductMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<AddVariantToProductMutation, AddVariantToProductMutationVariables>(AddVariantToProductDocument, options);
      }
export type AddVariantToProductMutationHookResult = ReturnType<typeof useAddVariantToProductMutation>;
export type AddVariantToProductMutationResult = Apollo.MutationResult<AddVariantToProductMutation>;
export type AddVariantToProductMutationOptions = Apollo.BaseMutationOptions<AddVariantToProductMutation, AddVariantToProductMutationVariables>;
export const UpdateVariantInProductDocument = gql`
    mutation updateVariantInProduct($id: String!, $productId: String!, $input: UpdateVariantInput!) {
  updateVariant(id: $id, productId: $productId, input: $input) {
    ...
    `;
export type UpdateVariantInProductMutationFn = Apollo.MutationFunction<UpdateVariantInProductMutation, UpdateVariantInProductMutationVariables>;
 ...
 * });
 */
export function useUpdateVariantInProductMutation(baseOptions?: Apollo.MutationHookOptions<UpdateVariantInProductMutation, UpdateVariantInProductMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateVariantInProductMutation, UpdateVariantInProductMutationVariables>(UpdateVariantInProductDocument, options);
      }
export type UpdateVariantInProductMutationHookResult = ReturnType<typeof useUpdateVariantInProductMutation>;
export type UpdateVariantInProductMutationResult = Apollo.MutationResult<UpdateVariantInProductMutation>;
export type UpdateVariantInProductMutationOptions = Apollo.BaseMutationOptions<UpdateVariantInProductMutation, UpdateVariantInProductMutationVariables>;
export const ArchiveVariantOfProductDocument = gql`
  ...
  archiveVariant(id: $id, productId: $productId) {
    ...
    `;
export type ArchiveVariantOfProductMutationFn = Apollo.MutationFunction<ArchiveVariantOfProductMutation, ArchiveVariantOfProductMutationVariables>;
 ...
 * });
 */
export function useArchiveVariantOfProductMutation(baseOptions?: Apollo.MutationHookOptions<ArchiveVariantOfProductMutation, ArchiveVariantOfProductMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<ArchiveVariantOfProductMutation, ArchiveVariantOfProductMutationVariables>(ArchiveVariantOfProductDocument, options);
      }
export type ArchiveVariantOfProductMutationHookResult = ReturnType<typeof useArchiveVariantOfProductMutation>;
export type ArchiveVariantOfProductMutationResult = Apollo.MutationResult<ArchiveVariantOfProductMutation>;
export type ArchiveVariantOfProductMutationOptions = Apollo.BaseMutationOptions<ArchiveVariantOfProductMutation, ArchiveVariantOfProductMutationVariables>;
export const RestoreVariantOfProductDocument = gql`
  ...
  restoreVariant(id: $id, productId: $productId) {
    ...
    `;
export type RestoreVariantOfProductMutationFn = Apollo.MutationFunction<RestoreVariantOfProductMutation, RestoreVariantOfProductMutationVariables>;
 ...
 * });
 */
export function useRestoreVariantOfProductMutation(baseOptions?: Apollo.MutationHookOptions<RestoreVariantOfProductMutation, RestoreVariantOfProductMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<RestoreVariantOfProductMutation, RestoreVariantOfProductMutationVariables>(RestoreVariantOfProductDocument, options);
      }
export type RestoreVariantOfProductMutationHookResult = ReturnType<typeof useRestoreVariantOfProductMutation>;
export type RestoreVariantOfProductMutationResult = Apollo.MutationResult<RestoreVariantOfProductMutation>;
export type RestoreVariantOfProductMutationOptions = Apollo.BaseMutationOptions<RestoreVariantOfProductMutation, RestoreVariantOfProductMutationVariables>;
export const RemoveVariantfromProductDocument = gql`
  ...
  removeVariant(id: $id, productId: $productId) {
    ...
    `;
export type RemoveVariantfromProductMutationFn = Apollo.MutationFunction<RemoveVariantfromProductMutation, RemoveVariantfromProductMutationVariables>;
 ...
 * });
 */
export function useRemoveVariantfromProductMutation(baseOptions?: Apollo.MutationHookOptions<RemoveVariantfromProductMutation, RemoveVariantfromProductMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<RemoveVariantfromProductMutation, RemoveVariantfromProductMutationVariables>(RemoveVariantfromProductDocument, options);
      }
export type RemoveVariantfromProductMutationHookResult = ReturnType<typeof useRemoveVariantfromProductMutation>;
export type RemoveVariantfromProductMutationResult = Apollo.MutationResult<RemoveVariantfromProductMutation>;
export type RemoveVariantfromProductMutationOptions = Apollo.BaseMutationOptions<RemoveVariantfromProductMutation, RemoveVariantfromProductMutationVariables>;