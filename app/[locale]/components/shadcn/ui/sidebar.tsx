  ...
  if (collapsible === 'none') {
    return (
      <div
        data-slot="sidebar"
        className={cn(
          'text-sidebar-foreground flex h-full w-(--sidebar-width) flex-col bg-amber-200',
          className,
        )}
        {...props}
      >
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      {...props}
    >
      <PanelLeftIcon className="text-text size-6 sm:size-7" />
