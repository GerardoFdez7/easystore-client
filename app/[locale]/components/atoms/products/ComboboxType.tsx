...
export default function ComboboxType({
  value,
  onValueChange,
  className = 'placeholder:text-muted-foreground text-[12px] sm:text-[14px] w-[90px] sm:w-[160px] bg-card border-input hover:border-input text-foreground h-9 rounded-full px-3 text-left [&_.border-primary]:border-foreground [&_.text-primary]:text-foreground [&_svg]:text-foreground dark:bg-input/30',
  disabled,
}: SelectTypeProps) {
